...
class Agent():
    ...
    def __init__(self, state_size, action_size, random_seed, update_every=1, actor_fc1_units=400, actor_fc2_units=300,critic_fcs1_units=400, critic_fc2_units=300,gamma=0.99, tau=1e-3,         lr_actor=1e-4, lr_critic=1e-3, weight_decay=0,mu=0., theta=0.15, sigma=0.2):
